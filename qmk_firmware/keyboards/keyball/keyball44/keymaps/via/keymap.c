...
LCTL_T(KC_ESC),KC_A     , KC_S     , KC_D    , KC_F     , KC_G     ,                                         KC_H     , KC_J     , KC_K     , KC_L     , KC_SCLN  , RCTL_T(KC_EQL),
  ...
  [1] = LAYOUT_universal(
    ...
    _______  ,  KC_GRV  , KC_QUOT  , KC_LBRC , KC_RBRC  , KC_BSLS  ,                                         KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , KC_INS   , _______  ,
  ...
  [2] = LAYOUT_universal(
    ...
    _______  ,S(KC_GRV),S(KC_QUOT),S(KC_LBRC),S(KC_RBRC),S(KC_BSLS),                                         _______  , _______  , _______  , _______  , _______  , _______  ,
