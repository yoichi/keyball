...
LCTL_T(KC_ESC),KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                  KC_H     , KC_J     , KC_K     , KC_L     , KC_SCLN  , RCTL_T(KC_EQL),
    ...
    MO(1)    , KC_LCTL  , KC_LALT  , KC_LGUI  , KC_LCTL  , KC_SPC   , MO(3)    ,            KC_BSPC,LT(2,KC_ENT), _______  , _______  , _______  , KC_RALT  , MO(1)
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            A(KC_GRV), KC_PGDN  , _______  , _______  , _______  , _______  , KC_BTN2  ,
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , _______  , SCRL_DVD , SCRL_DVI , SCRL_MO  , SCRL_TO  , _______  ,            _______  , KC_PGDN  , AG_LSWP  , AG_LNRM  , _______  , _______  , KC_BTN2  ,
    _______  , KC_BTN3  , KC_BTN2  , _______  , KC_BTN1  , _______  , _______  ,            _______  , _______  , _______  , _______  , _______  , KC_BTN5  , _______
  ),
};
// clang-format on
