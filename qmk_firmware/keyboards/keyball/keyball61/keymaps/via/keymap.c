...
LCTL_T(KC_ESC),KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                  KC_H     , KC_J     , KC_K     , KC_L     , KC_SCLN  , RCTL_T(KC_MINS),
  ...
  [1] = LAYOUT_universal(
    ...
    _______  , _______  , _______  ,S(KC_HOME), S(KC_END), _______  , KC_DEL   ,            KC_CAPS  , _______  , _______  , _______  , _______  , _______  , _______  ,
    _LAYER_  , _______  , _______  , _______  , KC_HOME  , _LAYER_  , KC_END   ,            _______  , _______  , _______  , _______  ,_______,RCTL(KC_RALT), _LAYER_
  ),
  ...
  [2] = LAYOUT_universal(
   ...
   S(KC_QUOT), S(KC_1)  , S(KC_2)  , S(KC_3)  , S(KC_4)  , S(KC_5)  ,                                  S(KC_6)  , S(KC_7)  , S(KC_8)  , S(KC_9)  , S(KC_0)  ,S(KC_BSLS),
    ...
    _______  , _______  , _______  , KC_BTN2  , KC_BTN1  ,S(KC_HOME), S(KC_END),            _______  , _LAYER_  , _______  , _______  , _______  , _______  , _______
  ),

  [3] = LAYOUT_universal(
    MO(4)    , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                  _______  , _______  , _______  , _______  , KC_BRMU  , KC_VOLU  ,
    _______  ,S(KC_LEFT),S(KC_DOWN), S(KC_UP) ,S(KC_RGHT), KC_PGUP  ,                                 C(KC_LEFT),C(KC_DOWN), C(KC_UP) ,C(KC_RGHT), KC_BRMD  , KC_VOLD  ,
    _______  , _______  , _______  , _______  , _______  , KC_PGDN  , _______  ,            _______  , _______  , _______  , _______  , _______  , _______  , KC_MUTE  ,
  ...
  [4] = LAYOUT_universal(
    ...
    QK_BOOT  , _______  , SCRL_DVD , SCRL_DVI , SCRL_MO  , SCRL_TO  , _______  ,            _______  , _______  , AG_LSWP  , AG_LNRM  , _______  , _______  , _______  ,
